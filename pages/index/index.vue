...
<!-- 		<up-status-bar></up-status-bar> -->
		...
		<view class="header">
			<view class="header-content">
				...
				<view class="header-actions">
					<up-icon name="plus-circle" size="28" :color="headerIconColor" @tap="goToAdd"></up-icon>
				</view>
			</view>
		</view>
		...
		<view class="nav-container">
			<view class="nav-item" @tap="goToAdd">
				<view class="nav-icon">
					<up-icon name="camera" size="24" :color="navIconColors.camera"></up-icon>
				</view>
				<text class="nav-text">上传图片</text>
			</view>
			<view class="nav-item" @tap="goToCollect">
				<view class="nav-icon">
					<up-icon name="heart" size="24" :color="navIconColors.heart"></up-icon>
				</view>
				<text class="nav-text">我的收藏</text>
			</view>
			<view class="nav-item" @tap="goToMine">
				<view class="nav-icon">
					<up-icon name="account" size="24" :color="navIconColors.account"></up-icon>
				</view>
		    ...
		    <view 
				...
				<view class="album-image-container">
					...
					<view class="album-overlay">
						<up-icon name="eye" size="20" :color="albumIconColors.eye"></up-icon>
					</view>
				</view>
		        <view class="album-info">
					...
					<view class="album-meta">
						<view class="album-tag">
							<up-icon name="tag" size="12" :color="albumIconColors.tag"></up-icon>
							<text>{{ album.tag }}</text>
						</view>
						<view class="album-stats">
							<up-icon name="thumb-up" size="12" :color="albumIconColors.thumbUp"></up-icon>
